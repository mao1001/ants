...
class Place {
    ...
    //Add insect to the current place
    _addInsect(insect) {
    ...
    //Removes the insect from the current place.
    ...
    //returns an Ant on this spot.
    get ant() {
        return this._ant;
    }
    
    //returns all Bees on this spot.
    get bees() {
        return this._bees;
    }
    
    //returns a boolean indicating whether or not this spot is a water tile or not.
    get water() {
        return this._water;
    }
...
class AntColony {
    ...
    //Deploys an ant to a new spot. returns true if successful and false if not.
    ...
    //Increases food of the whole colony by an interger amount.
    increaseFood(amount) {
        this._food += amount;
    }
    
    //Removes the ant from a place spot.
    removeAnt(place) {
        place.ant = undefined;
    }
    ...
    //gets the food amount for the colony.
    get food() {
        return this._food;
    }
    ...
    //returns the current queen if any.
    get queen() {
        return this._queen;
    }
    
    //sets the queen to the queen in the colony.
    set queen(queen) {
        this._queen = queen;
    }

    //gets the location spot of the queen.
    get queenPlace() {
    ...
    //returns true if there is a single bee on the same spot as the bee.
    get queenHasBees() {
...
class Insect {
    ...
    //returns an integer indicating the amount of armor the unit has.
    get armor() {
        return this._armor;
    }
   
    //returns a boolean determining whether or not this insect is a container or not. 
    get container() {
        return this._container;
    }
    
    //returns the contained insect if possible
    get contained() {
        return this._contained;
    }
    
    //sets a new contained insect to the passsed in one.
    set contained(newContained) {
        this._contained = newContained;
    }

    //returns a boolean determining if this insect can be removed or not.
    get immovable() {
    ...
    //returns the spot this insect is on.
    get place() {
        return this._place;
    }
    
    //sets this spot to a new one.
    set place(place) {
        console.log("bye");
    ...
    //returns a booleans signifying whether or not this unit has stealth.
    get stealth() {
        return this._stealth;
    }
    
    //returns a booleans signifiying whether or not this unit is watersafe or not.
    get watersafe() {
